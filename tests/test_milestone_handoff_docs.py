...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1335 shapes", handoff)
        self.assertIn("173 shapes", handoff)
        self.assertIn("292 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("8,071 bytes with 121 bytes free", handoff)
        self.assertIn("remaining 34 MATH1 routines", handoff)

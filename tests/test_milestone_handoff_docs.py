...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1382 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("316 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,336 bytes with 856 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,830 bytes with 362 bytes free", handoff)
        ...
        self.assertIn("8,149 bytes with 43 bytes free", handoff)
        ...
        self.assertIn("7,229 bytes with 963 bytes free", handoff)
        self.assertIn("6,132 bytes with 2,060 bytes free", handoff)
        self.assertIn("7,000 bytes with 1,192 bytes free", handoff)
        self.assertIn("7,122 bytes with 1,070 bytes free", handoff)
        self.assertIn("7,477 bytes with 715 bytes free", handoff)
        self.assertIn("remaining 10", handoff)

...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1386 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("73 shapes", handoff)
        self.assertIn("320 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,346 bytes with 846 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,840 bytes with 352 bytes free", handoff)
        ...
        self.assertIn("8,159 bytes with 33 bytes free", handoff)
        ...
        self.assertIn("7,371 bytes with 821 bytes free", handoff)
        self.assertIn("6,142 bytes with 2,050 bytes free", handoff)
        self.assertIn("7,010 bytes with 1,182 bytes free", handoff)
        self.assertIn("7,132 bytes with 1,060 bytes free", handoff)
        self.assertIn("7,135 bytes with 1,057 bytes free", handoff)
        self.assertIn("7,159 bytes with 1,033 bytes free", handoff)
        self.assertIn("7,163 bytes with 1,029 bytes free", handoff)
        self.assertIn("7,485 bytes with 707 bytes free", handoff)
        self.assertIn("remaining 6", handoff)
        ...
        self.assertIn("RT_F_HAVERSIN.OBJ", handoff)

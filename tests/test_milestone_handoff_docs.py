...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1370 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("304 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,289 bytes with 903 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,783 bytes with 409 bytes free", handoff)
        ...
        self.assertIn("8,102 bytes with 90 bytes free", handoff)
        ...
        self.assertIn("6,840 bytes with 1,352 bytes free", handoff)
        self.assertIn("6,084 bytes with 2,108 bytes free", handoff)
        self.assertIn("6,953 bytes with 1,239 bytes free", handoff)
        self.assertIn("7,075 bytes with 1,117 bytes free", handoff)
        self.assertIn("7,432 bytes with 760 bytes free", handoff)
        self.assertIn("remaining 22", handoff)

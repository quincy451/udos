...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1374 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("308 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,317 bytes with 875 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,811 bytes with 381 bytes free", handoff)
        ...
        self.assertIn("8,130 bytes with 62 bytes free", handoff)
        ...
        self.assertIn("8,092 bytes with 100 bytes free", handoff)
        self.assertIn("6,965 bytes with 1,227 bytes free", handoff)
        self.assertIn("6,112 bytes with 2,080 bytes free", handoff)
        self.assertIn("6,981 bytes with 1,211 bytes free", handoff)
        self.assertIn("7,103 bytes with 1,089 bytes free", handoff)
        self.assertIn("7,460 bytes with 732 bytes free", handoff)
        self.assertIn("remaining 18", handoff)

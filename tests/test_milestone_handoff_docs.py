...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1379 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("313 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,345 bytes with 847 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,839 bytes with 353 bytes free", handoff)
        ...
        self.assertIn("8,158 bytes with 34 bytes free", handoff)
        ...
        self.assertIn("8,084 bytes with 108 bytes free", handoff)
        self.assertIn("7,129 bytes with 1,063 bytes free", handoff)
        self.assertIn("6,140 bytes with 2,052 bytes free", handoff)
        self.assertIn("7,009 bytes with 1,183 bytes free", handoff)
        self.assertIn("7,131 bytes with 1,061 bytes free", handoff)
        self.assertIn("7,488 bytes with 704 bytes free", handoff)
        self.assertIn("remaining 13", handoff)

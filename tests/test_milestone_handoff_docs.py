...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1380 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("314 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,323 bytes with 869 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,817 bytes with 375 bytes free", handoff)
        ...
        self.assertIn("8,136 bytes with 56 bytes free", handoff)
        ...
        self.assertIn("8,091 bytes with 101 bytes free", handoff)
        self.assertIn("7,162 bytes with 1,030 bytes free", handoff)
        self.assertIn("6,119 bytes with 2,073 bytes free", handoff)
        self.assertIn("6,987 bytes with 1,205 bytes free", handoff)
        self.assertIn("7,109 bytes with 1,083 bytes free", handoff)
        self.assertIn("7,464 bytes with 728 bytes free", handoff)
        self.assertIn("remaining 12", handoff)

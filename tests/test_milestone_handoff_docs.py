...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1371 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("305 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,296 bytes with 896 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,790 bytes with 402 bytes free", handoff)
        ...
        self.assertIn("8,109 bytes with 83 bytes free", handoff)
        ...
        self.assertIn("8,089 bytes with 103 bytes free", handoff)
        self.assertIn("6,870 bytes with 1,322 bytes free", handoff)
        self.assertIn("6,091 bytes with 2,101 bytes free", handoff)
        self.assertIn("6,960 bytes with 1,232 bytes free", handoff)
        self.assertIn("7,082 bytes with 1,110 bytes free", handoff)
        self.assertIn("7,439 bytes with 753 bytes free", handoff)
        self.assertIn("remaining 21", handoff)

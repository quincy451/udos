...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1381 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("315 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,329 bytes with 863 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,823 bytes with 369 bytes free", handoff)
        ...
        self.assertIn("8,142 bytes with 50 bytes free", handoff)
        ...
        self.assertIn("7,195 bytes with 997 bytes free", handoff)
        self.assertIn("6,125 bytes with 2,067 bytes free", handoff)
        self.assertIn("6,993 bytes with 1,199 bytes free", handoff)
        self.assertIn("7,115 bytes with 1,077 bytes free", handoff)
        self.assertIn("7,470 bytes with 722 bytes free", handoff)
        self.assertIn("remaining 11", handoff)

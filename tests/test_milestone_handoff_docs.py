...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1376 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("310 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,334 bytes with 858 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,828 bytes with 364 bytes free", handoff)
        ...
        self.assertIn("8,061 bytes with 131 bytes free", handoff)
        self.assertIn("7,031 bytes with 1,161 bytes free", handoff)
        self.assertIn("6,129 bytes with 2,063 bytes free", handoff)
        ...
        self.assertIn("remaining 16", handoff)

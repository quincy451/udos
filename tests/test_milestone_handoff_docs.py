...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1373 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("307 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,310 bytes with 882 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,804 bytes with 388 bytes free", handoff)
        ...
        self.assertIn("8,123 bytes with 69 bytes free", handoff)
        ...
        self.assertIn("6,932 bytes with 1,260 bytes free", handoff)
        self.assertIn("6,105 bytes with 2,087 bytes free", handoff)
        self.assertIn("6,974 bytes with 1,218 bytes free", handoff)
        self.assertIn("7,096 bytes with 1,096 bytes free", handoff)
        self.assertIn("7,453 bytes with 739 bytes free", handoff)
        self.assertIn("remaining 19", handoff)

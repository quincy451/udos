...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1384 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("71 shapes", handoff)
        self.assertIn("318 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,338 bytes with 854 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,832 bytes with 360 bytes free", handoff)
        ...
        self.assertIn("8,151 bytes with 41 bytes free", handoff)
        ...
        self.assertIn("8,096 bytes with 96 bytes free", handoff)
        self.assertIn("7,294 bytes with 898 bytes free", handoff)
        self.assertIn("6,134 bytes with 2,058 bytes free", handoff)
        self.assertIn("7,002 bytes with 1,190 bytes free", handoff)
        self.assertIn("7,124 bytes with 1,068 bytes free", handoff)
        self.assertIn("7,127 bytes with 1,065 bytes free", handoff)
        self.assertIn("7,151 bytes with 1,041 bytes free", handoff)
        self.assertIn("7,155 bytes with 1,037 bytes free", handoff)
        self.assertIn("7,479 bytes with 713 bytes free", handoff)
        self.assertIn("remaining 8", handoff)

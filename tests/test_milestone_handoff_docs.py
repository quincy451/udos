...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1375 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("309 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,325 bytes with 867 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,819 bytes with 373 bytes free", handoff)
        ...
        self.assertIn("8,138 bytes with 54 bytes free", handoff)
        ...
        self.assertIn("8,052 bytes with 140 bytes free", handoff)
        self.assertIn("6,999 bytes with 1,193 bytes free", handoff)
        self.assertIn("6,120 bytes with 2,072 bytes free", handoff)
        self.assertIn("6,989 bytes with 1,203 bytes free", handoff)
        self.assertIn("7,111 bytes with 1,081 bytes free", handoff)
        self.assertIn("7,468 bytes with 724 bytes free", handoff)
        self.assertIn("remaining 17", handoff)

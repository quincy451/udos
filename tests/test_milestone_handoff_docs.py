...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1383 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("70 shapes", handoff)
        self.assertIn("317 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,343 bytes with 849 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,837 bytes with 355 bytes free", handoff)
        ...
        self.assertIn("8,156 bytes with 36 bytes free", handoff)
        ...
        self.assertIn("7,260 bytes with 932 bytes free", handoff)
        self.assertIn("6,139 bytes with 2,053 bytes free", handoff)
        self.assertIn("7,007 bytes with 1,185 bytes free", handoff)
        self.assertIn("7,129 bytes with 1,063 bytes free", handoff)
        self.assertIn("7,484 bytes with 708 bytes free", handoff)
        self.assertIn("remaining 9", handoff)

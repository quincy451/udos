...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1385 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("72 shapes", handoff)
        self.assertIn("319 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,347 bytes with 845 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,841 bytes with 351 bytes free", handoff)
        ...
        self.assertIn("8,160 bytes with 32 bytes free", handoff)
        ...
        self.assertIn("8,095 bytes with 97 bytes free", handoff)
        self.assertIn("7,330 bytes with 862 bytes free", handoff)
        self.assertIn("6,143 bytes with 2,049 bytes free", handoff)
        self.assertIn("7,011 bytes with 1,181 bytes free", handoff)
        self.assertIn("7,133 bytes with 1,059 bytes free", handoff)
        self.assertIn("7,136 bytes with 1,056 bytes free", handoff)
        self.assertIn("7,160 bytes with 1,032 bytes free", handoff)
        self.assertIn("7,164 bytes with 1,028 bytes free", handoff)
        self.assertIn("7,488 bytes with 704 bytes free", handoff)
        self.assertIn("remaining 7", handoff)
        ...
        self.assertIn("RT_F_VERSIN.OBJ", handoff)

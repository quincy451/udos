...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1378 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("312 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("8,077 bytes with 115 bytes free", handoff)
        self.assertIn("7,096 bytes with 1,096 bytes free", handoff)
        self.assertIn("6,141 bytes with 2,051 bytes free", handoff)
        self.assertIn("7,010 bytes with 1,182 bytes free", handoff)
        self.assertIn("7,132 bytes with 1,060 bytes free", handoff)
        self.assertIn("7,489 bytes with 703 bytes free", handoff)
        self.assertIn("remaining 14", handoff)

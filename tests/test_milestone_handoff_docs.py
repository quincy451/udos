...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1372 shapes", handoff)
        self.assertIn("196 shapes", handoff)
        self.assertIn("306 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("7,303 bytes with 889 bytes free", handoff)
        self.assertIn("real_function_for_postfix.act", handoff)
        self.assertIn("ACTC_OVLS.BIN", handoff)
        self.assertIn("7,797 bytes with 395 bytes free", handoff)
        ...
        self.assertIn("8,116 bytes with 76 bytes free", handoff)
        ...
        self.assertIn("8,096 bytes with exactly 96 bytes free", handoff)
        self.assertIn("6,896 bytes with 1,296 bytes free", handoff)
        self.assertIn("6,098 bytes with 2,094 bytes free", handoff)
        self.assertIn("6,967 bytes with 1,225 bytes free", handoff)
        self.assertIn("7,089 bytes with 1,103 bytes free", handoff)
        self.assertIn("7,446 bytes with 746 bytes free", handoff)
        self.assertIn("remaining 20", handoff)

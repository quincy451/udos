...
class MilestoneHandoffDocsTests(unittest.TestCase):
    def test_handoff_matches_current_project_boundary(self) -> None:
        ...
        self.assertIn("1336 shapes", handoff)
        self.assertIn("173 shapes", handoff)
        self.assertIn("293 complex compiled-runtime cases", handoff)
        ...
        self.assertIn("8,082 bytes with 110 bytes free", handoff)
        self.assertIn("remaining 33 MATH1 routines", handoff)

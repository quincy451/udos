...
- added release-style boot packaging for VICE:
  ...
  - `make vice-action-alink` now uses the release image with deterministic
    ...
    `OBJ/*.OBJ`.
  - `make vice-action-alink-prg-matrix` now enumerates 1378 direct-PRG
    ...
    `143` from direct PRGs. Pass N is 7,128 bytes with 1,064 bytes free under
    ...
    direct PRGs print `43` and `154`; the 7,131-byte overlay retains 1,061 bytes
    ...
    direct PRGs print `33` and `154`; the 7,155-byte overlay retains 1,037 bytes
    ...
    6502 path matches. The 7,159-byte overlay retains 1,033 bytes under the
    ...
    binary32 4.0 and 3.0; Idun's generated-6502 path matches. The 7,342-byte
    overlay retains 850 bytes under a dedicated 768-byte gate.
    ...
    7.0; Idun's generated-6502 path matches. The 7,836-byte overlay retains 356
    ...
    Idun's generated-6502 path matches. The 8,155-byte overlay retains 37 bytes

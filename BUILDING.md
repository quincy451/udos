...
- `make vice-action-alink-prg-matrix`
  ...
  - currently enumerates 1361 object/link shapes
...
- `make vice-action-actc-alink-launch-object-emission-matrix`
  ...
  - currently enumerates all 193 non-runtime, non-object-code source-backed
  ...
  - validates helper-free source, local/external calls, integer control flow,
    ...
    `EXIT`, and constant-bound CARD-counter `FOR` loops with positive or

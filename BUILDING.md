...
- `make vice-action-alink-prg-matrix`
  ...
  - currently enumerates 1362 object/link shapes
...
- `make vice-action-actc-alink-launch-object-emission-matrix`
  ...
  - currently enumerates all 194 non-runtime, non-object-code source-backed
  ...
  - validates helper-free source, local/external calls, integer control flow,
    ...
    constant steps, and nested loops with named CARD initial/final bounds
